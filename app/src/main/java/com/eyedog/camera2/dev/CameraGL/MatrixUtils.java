...
public enum MatrixUtils {
            ...
            if (sWhImg > sWhView) {
                switch (type) {
                    case TYPE_CENTERCROP:
                        Matrix.orthoM(projection, 0, -sWhView / sWhImg, sWhView / sWhImg, -1, 1, 1,
                            3);
                        break;
                    case TYPE_CENTERINSIDE:
                        Matrix.orthoM(projection, 0, -1, 1, -sWhImg / sWhView, sWhImg / sWhView, 1,
                            3);
                        break;
                    case TYPE_FITSTART:
    ...
    public static void logFloatArr(float[] m) {
        if (m != null && m.length > 0) {
            ...
            Log.i("logFloatArr", stringBuilder.toString());
        }
    }
